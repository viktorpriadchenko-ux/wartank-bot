...
type Бот struct {
	...
	клановаяВойна  ИАренаСтроение
	схватки        ИАренаСтроение
...
func создатьЯдроВарБот(конфиг *bot_config.БотКонфиг) *Бот {
	...
	сам.клановаяВойна = lev2.НовАренаКлановаяВойна(сам.конт)
	сам.схватки = lev2.НовАренаСхватки(сам.конт)
...
func (сам *Бот) пуск() {
	...
	for {
		...
		default:
			...
			безопасноПуск("клановаяВойна", func() { сам.клановаяВойна.Пуск() })
			безопасноПуск("схватки", func() { сам.схватки.Пуск() })
